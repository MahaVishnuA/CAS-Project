...
public class TC_001_News_Around_Cognizant extends BaseClass{
	...
	public void validateUser()  {
		...
		//Validating name
		Assert.assertEquals(name, "A, Maha Vishnu (Contractor)");
		...
		//Validating email
		Assert.assertEquals(email, "2318459@cognizant.com");}
		catch(Exception e) {
			e.printStackTrace();
		}
...

	{
	    ...
	    System.out.println("First 5 News Headers of Second Page are : ");
	     ...
	     for(int k=0;k<5;k++) {
	    	 ...
	    	 if(SecondPageNews.equals(tooltip)) {
